...
//        List<Others> others = mThemesBean.getOthers();
//        mItems = new ArrayList<>();
//        for (int i=0;i<others.size();i++){
//            LvMenuItem tmp = new LvMenuItem(others.get(i).getName());
//            mItems.add(tmp);
//        }
...
//            new ArrayList<LvMenuItem>(
//            Arrays.asList(
//                    new LvMenuItem(R.drawable.ic_home, "Home"),
//
//                    new LvMenuItem("Sub Items1"),
//                    new LvMenuItem("Sub Items2"),
//                    new LvMenuItem("Sub Items3"),
//                    new LvMenuItem("Sub Items4"),
//                    new LvMenuItem("Sub Items5")
//
//            ));
